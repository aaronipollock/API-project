...
//                         <button className='delete-confirm-button' onClick={handleDeleteEvent}>Yes (Delete Event)</button>
//                         <button className='delete-cancel-button' onClick={() => setShowDeleteModal(false)}>No (Keep Event)</button>
//                     </div>
//                 </div>
//             )}
//         </div>
