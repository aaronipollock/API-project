    ...
    useEffect(() => {
        const fetchGroupDetails = async () => {
            try {
                ...
                const eventData = isJSONResponse(eventRes) ? await groupRes.json() : {};
        ...
        <div className="group-details-page">
            ...
            <div className="group-details">
                ...
                <div className="group-info">
                    ...
                    <p className="group-events">{groupEvents.length} events</p>
                    <p className="group-privacy">{group.private ? 'Private' : 'Public'}</p>
                    <p className="group-organizer">Organized by {group.organizerId}</p>
